...
{
    public sealed class AuthLogic : IAuthService
    {
        ...
        private static readonly ILog Logger = LogManager.GetLogger(typeof(AuthLogic));
        ...
        public AuthLogic(PasswordService passwordService, IEmailService emailService)
        {
