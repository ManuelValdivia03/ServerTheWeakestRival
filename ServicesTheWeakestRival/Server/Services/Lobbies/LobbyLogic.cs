...
namespace ServicesTheWeakestRival.Server.Services
{
    ...
    public class LobbyLogic : ILobbyService
    {
        ...
        private static readonly ILog Logger = LogManager.GetLogger(typeof(LobbyLogic));
        ...
        private static void RemoveCallbackForLobby(Guid lobbyUid)
        {
            ...
            Logger.DebugFormat(
                "RemoveCallbackForLobby: LobbyUid={0}, SessionId={1}, RemainingInBucket={2}",
                lobbyUid,
                CurrentSessionId,
                bucket.Count);
        }
